...
| Level | Situation |
|:-----:|-----------|
| 1 | Your partner describes an imaginary object in their hands. For 60 seconds, "Yes, and..." every detail they add — shape it together until you both agree on what it is. |
...
| 3 | You are an overly dramatic nature documentary narrator covering the mundane drama of an open-plan office. Narrate 2 minutes of "wildlife" behaviour you observe. |
...
| 5 | You are a time traveller stuck in a 3-minute loop at the worst possible moment of a company all-hands meeting. Each loop, you remember everything from the previous one and try a different approach to escape — play all three attempts back to back. |
...
| Level | Situation |
|:-----:|-----------|
| 1 | Describe your perfect Sunday morning in vivid detail for 1 minute. In the last 10 seconds, reveal one detail that changes the meaning of everything you just said. |
